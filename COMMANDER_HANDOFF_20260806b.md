...
| 项 | 值 |
|---|---|
| 版本 | **9.28.0** (main = 6915763, CI run #32 七 job 全绿) |
| 发布链 | 9.26.0 (B/D/E) → 9.27.0 (C 覆盖轮) → 9.28.0 (审查轮五包修复) — **全部已推送 + CI 全绿 + zip 已打包** (Downloads + 桌面, 标准 319/full 321 文件) |
| 测试 | 1395+ 函数, 覆盖率 **98.4%**, 漂移门 0.000e+00 |
...
| **文档漂移守卫** | CODE_MAP 已改符号引用, 契约表数字人工维护 (弱势 4 部分落实) |
