...
- 方法: `perf_counter` 单次测量; 时间与内存分两次独立运行
...
- 误差: 本表是单机单次实测, 波动 ±20% 属正常; 跨版本对比请用脚本重跑。
...
|------|------|------|-----|-----|-----------|--------|------|------|---------|---------|
| 1k   | 1,024 | 1,089 | 2,178 | 35.5k | 4.5 | 6.0 | 28 (direct) | 0.6 | 4.0 | 5.2 |
| 10k  | 10,000 | 10,201 | 20,402 | 331k | 43 | 57 | 420 (direct) | 7.1 | 62 | 68 |
| 100k | 100,489 | 101,250 | 202,248 | 3.34M | 540 | 633 | 1,338 (cg) | 54 | 881 | 742 |
| 300k | 300,304 | 302,642 | 602,802 | 10.2M | 1,148 | 1,763 | 4,448 (cg) | 231 | 4,828 | 2,257 |

### CPS3 (CST 三角形, 常应变)

| 档位 | 单元 | 节点 | DOF | nnz | 连接/几何 | K 组装 | 求解 | 应力 | L2 恢复 | Z2 估计 |
|------|------|------|-----|-----|-----------|--------|------|------|---------|---------|
| 1k   | 1,058 | 576 | 1,152 | 13.2k | 1.3 | 1.8 | 8 (direct) | 0.2 | 5.5 | 2.9 |
| 10k  | 10,082 | 5,184 | 10,368 | 122k | 19 | 25 | 178 (direct) | 4.2 | 92 | 20 |
| 100k | 100,352 | 50,625 | 101,250 | 1.21M | 151 | 133 | 409 (cg) | 32 | 850 | 173 |
| 300k | 301,088 | 151,321 | 302,642 | 3.62M | 440 | 490 | 1,538 (cg) | 109 | 4,244 | 657 |
