...
>
> ⚠️ **现状快照 (2026-08-06, 9.28.0)**: 本文件是 9.27.0 包 2/4 补测试轮的
> 历史任务报告。此后覆盖轮持续补测，当前 TOTAL 语句覆盖 **98.3%**
> (8824 语句, 154 缺失), 全量 1628 collected → 1626 passed + 2 skipped
> (本机, gmsh API 可用、检出无捆绑 gmsh.exe)。以下"基线/完成"数字为
> 该轮当时实测, 属历史记录, 现状以快照为准。
...
(2026-08-03 当时全量 676 passed; 2026-08-04 复核全量 939 collected) 实测;
完成态为同命令最后一次全量实测。
